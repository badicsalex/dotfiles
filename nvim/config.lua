...
-- vim.cmd [[highlight link LspSemantic_punctuation  ]]
-- vim.cmd [[highlight link LspSemantic_attributeBracket  ]]
-- vim.cmd [[highlight link LspSemantic_angle  ]]
-- vim.cmd [[highlight link LspSemantic_brace  ]]
vim.cmd [[highlight link LspSemantic_bracket Operator]]
-- vim.cmd [[highlight link LspSemantic_parenthesis  ]]
-- vim.cmd [[highlight link LspSemantic_colon  ]]
-- vim.cmd [[highlight link LspSemantic_comma  ]]
-- vim.cmd [[highlight link LspSemantic_dot  ]]
-- vim.cmd [[highlight link LspSemantic_semi  ]]
