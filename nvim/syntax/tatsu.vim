...
syn region ebnfTerminal matchgroup=delimiter start=/"/ skip=/\\\\\|\\"/ end=/"/ contained contains=ebnfEscapeSequence
syn region ebnfTerminal matchgroup=delimiter start=/'/ skip=/\\\\\|\\'/ end=/'/ contained contains=ebnfEscapeSequence
syn region ebnfConstant matchgroup=delimiter start=/`/ skip=/\\\\\|\\`/ end=/`/ contained contains=ebnfEscapeSequence
